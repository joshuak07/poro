...
var j;
var zombie1,zombie2,zombie3,gameover,go,reset,b;zz
var score=0;
var PLAY=1;
var END=0;
var GAMESTATE=PLAY; 
...
if (GAMESTATE===END){
   go=createSprite(displayWidth/2,displayHeight/2,displayWidth,displayHeight);
   go.addImage(gameover);
   go.scale=5;

   b=createSprite(100,50,20,20)
   b.addImage(reset)
